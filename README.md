...
initialization-actions parameter to set up variables to later use in the pyspark script<br>
 ...
 - Assign Necessary permissions to service account. <br>
...
``pyspark_file_extract.py`` is parameterized to run again & again with different input file name ``--file_name`` value <br>
...
<img src="https://github.com/user-attachments/assets/8f1f480a-4ca1-4dca-ae94-60ee00110f29" width="700"/> 
